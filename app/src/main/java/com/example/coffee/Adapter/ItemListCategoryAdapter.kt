...
import com.example.coffee.databinding.ViewholderItemPicLeftBinding
import com.example.coffee.databinding.ViewholderItemPicRightBinding

//Adapter yang digunakan untuk menampilkan produk dalam bentuk list per kategori.
//logika Mengisi komponen UI: picMain dll
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        )
        {
            ...
            when(holder){
                ...
                //untuk rating dll dari item model
                is ViewholderITem2->{
                    holder.binding.titleTxt.text=titleTxt
                    holder.binding.priceTxt.text=priceTxt
                    holder.binding.ratingBar.rating=rating
